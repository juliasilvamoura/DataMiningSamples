...
def main():
   ...
   # x,y = load_dataset('Datasets/breast-cancer-output.data')
    ...
    # STEP 1 - TESTS USING
    # knn classifier write from scratch    
    ...
    plot_confusion_matrix(cm, ['nao cancer', 'cancer'], False, "Confusion Matrix - K-NN")      
    plot_confusion_matrix(cm, ['nao cancer', 'cancer'], True, "Confusion Matrix - K-NN normalized")  
    ...
    # Get test confusion matrix    
    cm = confusion_matrix(y_test, y_hat_test)        
    plot_confusion_matrix(cm, ['nao cancer', 'cancer'], False, "Confusion Matrix - K-NN sklearn")      
    plot_confusion_matrix(cm, ['nao cancer', 'cancer'], True, "Confusion Matrix - K-NN sklearn normalized" )  

    cross_validation = cross_val_score(knn, x, y, cv=10)
